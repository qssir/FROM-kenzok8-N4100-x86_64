...
# 📦 满血全家桶核心软件包对齐 (包含 FUSE 底层、Docker、存储下载、VPN组网、PassWall等，坚决不含 Python 编译组件)
EXTRA_PACKAGES="${EXTRA_PACKAGES:-luci luci-i18n-base-zh-cn luci-i18n-package-manager-zh-cn luci-app-daede kmod-sched-core kmod-sched-bpf kmod-veth kmod-xdp-sockets-diag curl nano kmod-fuse fuse-utils kmod-fs-ext4 kmod-fs-vfat kmod-fs-ntfs3 luci-app-dockerman docker-compose luci-app-alist luci-app-samba4 luci-app-minidlna luci-app-qbittorrent luci-app-transmission luci-app-aria2 luci-app-passwall luci-app-passwall_INCLUDE_Shadowsocks_Libev_Client luci-app-passwall_INCLUDE_Xray luci-app-zerotier luci-app-n2n luci-app-softethervpn luci-app-ipsec-vpnd luci-app-syncdial luci-app-eqos luci-app-wrtbwmon luci-app-ttyd luci-app-diskman luci-app-filebrowser luci-theme-argon}"
